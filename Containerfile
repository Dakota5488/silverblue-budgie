...
RUN rpm-ostree install budgie-control-center budgie-desktop budgie-screensaver budgie-desktop-view network-manager-applet atril caja gnome-tweaks spectacle neovim
